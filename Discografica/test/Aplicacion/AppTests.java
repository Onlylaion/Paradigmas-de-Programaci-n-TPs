 ...
 * 
 * Set<Artista> base = new HashSet<>();
 * base.add(a1);
 * base.add(a2);
 * Set<Artista> contratados = new HashSet<>();
 * 
 ...
 * 
 * HashMap<Rol, Integer> faltantesReal = (HashMap<Rol, Integer>)
 * r1.getRolesFaltantesCancion(c1);
 * 
 ...
 * HashMap<Rol, Integer> rolesCancion5 = new HashMap<>();
 * rolesCancion4.put(Rol.Baterista, 1);
 * rolesCancion4.put(Rol.Corista, 1);
 * rolesCancion4.put(Rol.VozPrincipal, 1);
 * rolesCancion5.put(Rol.Baterista, 1);
 * rolesCancion5.put(Rol.Bajista, 1);
 * 
 * c4 = new Cancion("Luna", 2, rolesCancion4);
 * //c5 = new Cancion("Perdido", 2, rolesCancion5);
 * 
 ...
 * //ArrayList<Rol> rolesArtista7 = new ArrayList<>();
 * 
 ...
 * //a7= new Artista("Vicentico", rolesArtista7, bandas6, 400, 5, 2);
 * 
 * 
 ...
 * 
 * //Quedarian :
 * //Adele como corista: le gana a Calamaro por el descuento al compartir banda
 * ($300)
 * //Cerati como voz principal: primer tenido en cuenta, por ser el primer base
 * ($750).
 * //Chano como baterista: es el único, tiene descuento por compartir banda
 * ($500).
 * 
 ...
 * 
 * HashMap<Artista, Rol> asignadosReal = (HashMap<Artista, Rol>)
 * contrato.getArtistasAsignados();
 * 
 * 
 ...
 * assertEquals(aux.getCosto(), aux.getCostoCancionBase() +
 * aux.getCostoCancionBase()* 0.5);
 * }
 * 
 * }
 */
